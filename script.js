...
async function mealDatabase() {
  try {
    ...
    let input_value = document.querySelector("#meal-db").value;
    ...
    div_row.innerHTML += ` <div class="col-12 details-card">
                <div class="card left-card" style="width: 18rem">
                    <div class="card-body">
                        <div class="mealname">MEAL - DETAILS:</div>
                        <ul class="list-group">
                            <span class="badge badge-dark">CATEGORY:<span class="badge badge-info">${mealCategory}</span></span>
                            <span class="badge badge-dark">AREA:<span class="badge badge-info">${mealArea}</span></span>
                            <span class="badge badge-dark">TAGS:<span class="badge badge-info">${mealTags}</span></span>
                        </ul>
                        <div>
